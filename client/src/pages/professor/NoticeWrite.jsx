...
export default function NoticeWrite() {
  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: 32 }}>
      <h2 style={{ fontWeight: 800, fontSize: 28, marginBottom: 24, color: '#222' }}>공지사항 작성</h2>
      <form onSubmit={handleSubmit} style={{ background: '#fff', borderRadius: 12, boxShadow: '0 2px 12px rgba(25,118,210,0.07)', padding: 32, border: '1px solid #e0e0e0' }}>
        ...
        <button type="submit" disabled={loading} style={{ background: '#1976d2', color: '#fff', border: 'none', borderRadius: 8, padding: '12px 44px', fontWeight: 700, fontSize: 18, cursor: 'pointer', boxShadow: '0 2px 8px rgba(25,118,210,0.08)' }}>작성</button>
